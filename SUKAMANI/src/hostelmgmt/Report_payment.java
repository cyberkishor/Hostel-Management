 ...
 * @author publisy
 */
public class Report_payment extends javax.swing.JInternalFrame {
...
jPanel1Layout.setHorizontalGroup(
    ...
    jLabel1.setText("Report : Payments");
    ...
    total1.setText("TOTAL Payments till date  ::");
    ...
    report_panelLayout.setHorizontalGroup(
        ...
        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, report_panelLayout.createSequentialGroup()
            .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
            .addComponent(total1, javax.swing.GroupLayout.PREFERRED_SIZE, 188, javax.swing.GroupLayout.PREFERRED_SIZE)
...
//        String fname = namesearch.getText();
        this.fillReportTable("SELECT payment.member_id, member.fname, member.lname,payment.pay_date, payment.pay_other, payment.pay_deduct, payment.pay_total from payment, member WHERE member.id = payment.member_id and `pay_date` between '"+fd+ "' and '"+td+"'");
    double total1 = 0;
    for (int i = 0; i < table_report.getRowCount();i++){
        total1 += Double.parseDouble(table_report.getValueAt(i, 6).toString());
    ...
    private void fillReportTable(String sql){
        ...
        try{
            ...
            dtm.addColumn("total paid");
            
            while(rs.next()){
                Object objData[] = new Object[7];
                for(int i = 0; i<7;i++){
