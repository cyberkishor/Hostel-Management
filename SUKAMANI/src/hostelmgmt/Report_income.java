 ...
 * @author publisy
 */
public class Report_income extends javax.swing.JInternalFrame {
...
jPanel1Layout.setHorizontalGroup(
    ...
    private void GoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GoActionPerformed
        ...
        this.fillReportTable("SELECT id, descr, detail, amount, created from income WHERE created between '"+fd+ "' and '"+td+"' and descr like '%"+fname+"%'");
        double total1 = 0;
