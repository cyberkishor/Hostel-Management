 ...
 * @author publisy
 */
public class Report_expense extends javax.swing.JInternalFrame {
...
jPanel1Layout.setHorizontalGroup(
    ...
    jLabel1.setText("Report : EXPENDITURE");
    ...
    private void GoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GoActionPerformed
        ...
        this.fillReportTable("SELECT id, descr, detail, amount, created from expenditure WHERE created between '"+fd+ "' and '"+td+"' and descr like '%"+fname+"%'");
        double total1 = 0;
    ...
    private void fillReportTable(String sql){
        ...
        try{
            ...
            dtm.addColumn("id");
            dtm.addColumn("Title");
            dtm.addColumn("Detail Description");
