 ...
 * @author publisy
 */
public class ReportAdmin extends javax.swing.JInternalFrame {
...
//        String fname = namesearch.getText();
        this.fillReportTable("SELECT id, fname, lname, address,gender,email,contact,parentno,date from member WHERE `date` between '"+fd+ "' and '"+td+"'");
