...
public class Expenditure extends javax.swing.JInternalFrame {
     ...
     */
    public Expenditure(userSession user) {
        initComponents();
        try {
        ...
        this.user = user;
        this.fillUserTable("SELECT id,descr,detail,amount From expenditure");
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Details of expenditure");

        userchkmsg.setForeground(new java.awt.Color(255, 51, 0));

        jLabel9.setText("Amount (RS)");

        jLabel10.setText("Expenditure Date");

        date.setCalendarPreferredSize(new java.awt.Dimension(300, 200));

        incDes.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Select Description", "Kitchen", "Furniture", "Utensils", "Stationery", "Electricity", "Water", "Salary", "Rent", "Others" }));
        ...
        jLabel7.setText("Expenditure Details");
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                        .addGap(20, 20, 20)
                                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(expenditure, javax.swing.GroupLayout.PREFERRED_SIZE, 235, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void EditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditActionPerformed
        ...
        String details =(String) trim(expenditure.getText());
        String amount = (String) trim(incAmt.getText());
        String id = exp_id.getText();
      ...
      String error    =   "";
        ...
        if(error.equals("")){
            String insertSQL = "UPDATE expenditure SET descr=?,detail=?,amount=?,modified_by=? where id = ?";
            String[] params = {description,details,amount,login, id};

        Integer b;
            try {
                b = connection.dbExecuteUpdate(insertSQL, params);
                JOptionPane.showMessageDialog(null, "Successfully updated");
                submit_add.setVisible(true);
                expenditure.setText("");
                incAmt.setText("");
                this.fillUserTable("SELECT id,descr,detail,amount From expenditure");
//    Errormsg.setText("");
...
//            String emessage = "<html><body>" + error + "</body></html>";
    ...
    private void searchKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_searchKeyTyped
        ...
        String sql = "SELECT id,descr,detail,amount From expenditure where descr like '%"+sq+"%'";
        this.fillUserTable(sql);
    }//GEN-LAST:event_searchKeyTyped

    private void userTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_userTableMouseClicked
        submit_add.setVisible(false);
        ...
        try{
            ...
            rs = pst.executeQuery();
            if(rs.next()){
                exp_id.setText(rs.getString("id"));
                incDes.setName(rs.getString("descr"));
                expenditure.setText(rs.getString("detail"));
                incAmt.setText(rs.getString("amount"));
                if("Kitchen".equals(rs.getString("descr")) ){
                    incDes.setSelectedIndex(1);
                }
                if("Furniture".equals(rs.getString("descr")) ){
                    incDes.setSelectedIndex(2);
                }
                if("Utensils".equals(rs.getString("descr")) ){
                    incDes.setSelectedIndex(3);
                }
                if("Stationery".equals(rs.getString("descr")) ){
                    incDes.setSelectedIndex(4);
                }
                if("Electricity".equals(rs.getString("descr")) ){
                    incDes.setSelectedIndex(5);
                }
                if("Water".equals(rs.getString("descr")) ){
                    incDes.setSelectedIndex(6);
                }
                if("Salary".equals(rs.getString("descr")) ){
                    incDes.setSelectedIndex(7);
                }
                if("Rent".equals(rs.getString("descr")) ){
                    incDes.setSelectedIndex(8);
                }
                if("Others".equals(rs.getString("descr")) ){
                    incDes.setSelectedIndex(9);
                }
            }
        }catch(Exception e){
    ...
    private void submit_addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submit_addActionPerformed
      ...
      String error    =   "";
        ...
        if(error.equals("")){
            String insertSQL = "INSERT INTO expenditure (descr,detail,amount,created_by) VALUES (?,?,?,?)";
...
//            String emessage = "<html><body>" + error + "</body></html>";
    ...
    submit_add.setVisible(true);
    expenditure.setText("");
    incAmt.setText("");        // TODO add your handling code here:
...
//        userTable.setModel(DbUtils.resultSetToTableModel(rs));
    ...
    private javax.swing.JLabel exp_id;
